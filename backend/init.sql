...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='选课记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='课程时间表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='图形验证码表';
...
-- 测试学生账户（10条数据）
INSERT INTO `students` (`username`, `password`, `phone`, `email`)
VALUES ('student1', '$2a$10$Qa/NKW56HT.gL8rN4jxVv.eaME.V8tx5vzR3I/uUr9e0jil3Ed0Iu', '13800001001', 'student1@test.com'),
       ...
       ('student10', '$2a$10$Qa/NKW56HT.gL8rN4jxVv.eaME.V8tx5vzR3I/uUr9e0jil3Ed0Iu', '13800001010',
        'student10@test.com');

-- 测试教师账户（10条数据）
INSERT INTO `teachers` (`username`, `password`, `email`)
VALUES ('teacher1', '$2a$10$Qa/NKW56HT.gL8rN4jxVv.eaME.V8tx5vzR3I/uUr9e0jil3Ed0Iu', 'teacher1@test.com'),
...
-- 测试课程（10条数据）
INSERT INTO `courses` (`name`, `description`, `teacher_id`, `capacity`, `enrolled`)
VALUES ('Golang高级编程', 'Go语言并发编程与性能优化，深入理解goroutine、channel、context等核心概念', 1, 30, 2),
...
VALUES (1, 1), -- student1 选了 Golang高级编程
...
INSERT INTO `course_schedules` (`course_id`, `day_of_week`, `time_slot`, `start_week`, `end_week`, `classroom`)
VALUES
